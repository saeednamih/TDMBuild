...
angular.module('angular-cron-jobs')
    ...
    .factory('cronService', ['baseFrequency', function(baseFrequency) {
        ...
        service.setDefaultCron = function(n){
            ...
            if (n && n.base && n.base >= baseFrequency.hour) {
                if (angular.isArray(n.minuteValues) && n.minuteValues.length == 0){
                    cron[0] = "*"
                }
                else {
            ...
            if (n && n.base && n.base >= baseFrequency.day) {
                if (angular.isArray(n.hourValues) && n.hourValues.length == 0){
                    cron[1] = "*"
                }
                else {
            ...
            if (n && n.base && n.base === baseFrequency.week) {
                ...
                if (angular.isArray(n.dayValues) && n.dayValues.length == 0){
                    ...
                    cron[4] = typeof n.dayValues !== "undefined" ? n.dayValues : "*";
                }
            }

            if (n && n.base && n.base >= baseFrequency.month) {
                if (angular.isArray(n.dayOfMonthValues) && n.dayOfMonthValues.length == 0){
                    cron[2] = "*"
                }
                else {
            ...
            if (n && n.base && n.base === baseFrequency.year) {
                if (angular.isArray(n.monthValues) && n.monthValues.length == 0){
                    cron[3] = "*"
                }
                else {
